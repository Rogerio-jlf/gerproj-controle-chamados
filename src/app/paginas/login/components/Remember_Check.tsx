         ...
         >
            <div className="relative">
               <input
                  ...
                  checked={rememberMe}
                  onChange={onToggle}
                  className="peer h-5 w-5 cursor-pointer appearance-none rounded border-2 border-white/30 bg-white/10 transition-all duration-200 checked:border-purple-500 checked:bg-purple-500/30 hover:border-white/50 focus:ring-2 focus:ring-purple-500/50 focus:outline-none"
               />
               <motion.svg
