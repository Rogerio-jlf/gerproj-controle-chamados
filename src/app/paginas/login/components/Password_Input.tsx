   ...
   return (
      ...
      >
         ...
         <div className="group relative">
            ...
            >
               <FaLock className="h-5 w-5 text-white/70 transition-colors duration-300 group-focus-within:text-purple-400" />
            </motion.div>
            ...
            >
               ...
               <Tooltip>
                  <TooltipTrigger asChild>
                     ...
                     >
                        {showPassword ? (
                           <FaRegEyeSlash className="h-5 w-5 text-white/80 hover:text-white" />
                        ) : (
                           <FaEye className="h-5 w-5 text-white/80 hover:text-white" />
                        )}
                     </motion.button>
                  </TooltipTrigger>
                  <TooltipContent
                     side="top"
                     className="max-w-md -translate-x-10 border border-slate-700/50 bg-slate-900/90 tracking-wider break-words text-white backdrop-blur-md transition-all duration-300"
                  >
