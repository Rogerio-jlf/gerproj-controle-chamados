    ...
    useEffect(() => {
        ...
        columnFilters.forEach(filter => {
            if (filter.id in newFilterValues) {
                newFilterValues[filter.id as keyof typeof newFilterValues] =
                    String(filter.value || '');
            }
        });
        ...
        <>
                        ...
                        {dataOS && dataOS.length === 0 && !isLoading && (
                            <section className="bg-black py-40 text-center">
                                ...
                                <h3 className="text-2xl font-bold tracking-widest text-white italic select-none">
                                    Nenhuma Ordem de Serviço foi encontrada para
                                    o chamado #{codChamado}.
                                </h3>
                            </section>
                        )}
                        {/* ===== */}
                            ...
                            table.getFilteredRowModel().rows.length === 0 && (
                                <section className="bg-slate-900 py-20 text-center">
                                    ...
                                    <h3 className="text-xl font-bold tracking-wider text-slate-200 select-none">
                                        Nenhum registro foi encontrado para os
                                        filtros aplicados.
                                    </h3>
                                    {/* Subtítulo */}
                                    <p className="mt-2 text-slate-400">
                                        Tente ajustar os filtros ou limpe-os
            ...
            {modalEditarOSOpen && selectedOS !== null && (
                <ModalEditarOS
                    ...
                    codOS={selectedOS}
                    nomeCliente={
                        dataOS?.find(os => os.COD_OS === selectedOS)
                            ?.NOME_CLIENTE
                    }
