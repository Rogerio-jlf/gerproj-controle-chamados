      ...
      <div className="flex w-full flex-col gap-1">
         ...
         <div ref={dropdownRef} className="relative w-full">
            ...
            <button
               ...
               className="flex w-full cursor-pointer items-center justify-between rounded-md bg-white px-4 py-3 font-bold tracking-widest text-black italic shadow-md shadow-black transition-all hover:shadow-xl hover:shadow-black focus:ring-4 focus:ring-pink-600 focus:outline-none active:scale-95"
            >
