   ...
   return (
      <div ref={dropdownRef} className="relative w-[300px]">
         <button
            ...
            className="group relative flex w-full cursor-pointer items-center justify-between rounded-md border-t border-black/10 bg-white py-3 pr-4 pl-10 font-bold tracking-widest text-black italic shadow-md shadow-black transition-all hover:bg-slate-200 focus:ring-2 focus:ring-pink-600 focus:outline-none active:scale-95"
         >
            <FaFilter
