...
// COMPONENTE
// ================================================================================
export function DropdownSimNaoRelatorioOS({
   value,
   onChange,
}: SelectSimNaoProps) {
   ...
   return (
      <div ref={dropdownRef} className="relative w-full">
         ...
         <button
            ...
            className="flex w-full cursor-pointer items-center justify-between rounded-md border border-teal-950 bg-gradient-to-br from-teal-700 to-teal-800 px-4 py-2.5 text-base font-extrabold tracking-widest italic transition-all hover:scale-105 focus:ring-2 focus:ring-pink-500 focus:outline-none"
         >
